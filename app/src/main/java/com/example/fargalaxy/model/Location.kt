...
data class Location(
    ...
    val shouldOverflowSelectionImage: Boolean = false, // If true, selection image extends beyond container (full height, wider than container)
    ...
    val faction: String, // Faction the location belongs to (e.g., "Alliance of Starfaring Nations", "Independent Systems Coalition", "Navakeshi Star Armada", "None")
