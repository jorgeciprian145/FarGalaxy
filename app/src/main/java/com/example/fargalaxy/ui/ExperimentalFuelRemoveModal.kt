...
/**
 * ExperimentalFuelRemoveModal composable - displays a confirmation modal when user tries to remove experimental fuel.
 * Shows remaining travels and asks for confirmation.
 * 
 * @param remainingTravels The number of remaining travels with experimental fuel
 ...
 */
@Composable
fun ExperimentalFuelRemoveModal(
    remainingTravels: Int = 0,
    onRemoveClick: () -> Unit = {},
    onCancelClick: () -> Unit = {},
    ...
    Box(
        ...
        Box(
            ...
            Column(
                ...
                // Title: "Remove Experimental fuel?" - bold, 28sp
                Text(
                    text = "Remove Experimental fuel?",
                    fontFamily = Exo2,
                    fontSize = 28.sp,
                ...
                // Label: "You still have (amount) travels remaining that will be lost" - regular, 16sp
                Text(
                    text = "You still have $remainingTravels travels remaining that will be lost",
                    fontFamily = Exo2,
                    fontSize = 16.sp,
                ...
                // Buttons row: REMOVE (primary) and CANCEL (secondary)
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = androidx.compose.foundation.layout.Arrangement.spacedBy(12.dp)
                ) {
                    // CANCEL button: Secondary style (white border, no fill)
                    Box(
                        modifier = Modifier
                            .weight(1f)
                            .height(48.dp)
                    ...
                    // REMOVE button: Primary style (white background)
                    Box(
                        modifier = Modifier
                            .weight(1f)
                            .height(48.dp)
