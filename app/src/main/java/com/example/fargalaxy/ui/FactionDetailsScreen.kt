...
private fun getFactionBackgroundResId(faction: String): Int {
    return when (faction) {
        ...
        "Independent Systems Coalition" -> R.drawable.factionbackgroundisf
...
private fun getFactionDetailLogoResId(faction: String): Int {
    return when (faction) {
        ...
        "Independent Systems Coalition" -> R.drawable.factiondetaillogoisf
